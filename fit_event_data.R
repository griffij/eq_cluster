...
#events <- c(30000, 50000, 90000, 500000) # Hyden
...
events <- c(17000,25000,50000,1000000,2000000) # Lake Edgar
...
#events <- c(1200,2900,120000) # Meers
#events <- c((2016-1812),(2016-1450),(2016-900),1000000) # NMSZ
...
print(model_fit$par)
present_rate <- model_fit$par[1] + model_fit$par[2]*exp(-(17000)/model_fit$par[3])
